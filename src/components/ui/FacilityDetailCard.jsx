...
const FacilityDetailCard = ({ facility, onClose }) => {
	...
	return (
		<>
			...
			<div
				ref={sheetRef}
				className={clsx("facility-detail-mobile", isOpen && "open")}
			...
			{/* Desktop Popup */}
			<div className="facility-detail-desktop px-8">
				<div className="relative bg-white pt-1 pb-1 mb-2">
					<button
						onClick={onClose}
						className="absolute -top-3 -right-2 p-1.5 bg-white hover:bg-gray-100 rounded-full transition-colors shadow-md"
				...
				<div className="flex justify-center mb-3">
					<p className="text-base md:text-lg text-brand-accent bg-brand-dark-blue py-1.5 px-6 rounded-lg font-semibold inline-block font-poppins">
						Detail Informasi Fasilitas
					</p>
				</div>
				<div className="flex items-center justify-between mb-4">
					<div className="flex items-center gap-3">
						...
						/>
						<h2 className="text-lg font-bold text-brand-dark-blue">{name}</h2>
					</div>
				</div>
				{/* Detail informasi */}
